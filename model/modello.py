...
class Model:
    ...
    def _ricorsione(self, parziale, rimanenti): #ci servono le soluzioni parziali e poi le lettere rimanenti, soluzioni è la collection dove salviamo tutte le sol parziali
        if len(rimanenti) == 0:  # condizione terminale: quando la collection di rimanneti è di lunghezza 0, non posso più formare soluzioni
            #print(parziale)
    ...
    # utilizzo liste di caratteri e ciclo sulla lista
